...
class RatingV1Controller(
    ...
    fun getRatingsByUserId(
        ...
        val response =
            ratingService.getRatingsByUserId(userId).map { rating ->
                fromRating(rating)
            }
        return ResponseEntity.ok(response)
    }
    ...
    fun getRatingsByMovieId(
        ...
        val response =
            ratingService.getRatingsByMovieId(movieId).map { rating ->
                fromRating(rating)
            }
        return ResponseEntity.ok(response)
    }
    ...
    fun getUserRatingProfile(
        @PathVariable userId: UUID,
    ): ResponseEntity<UserRatingProfileResponse> {
